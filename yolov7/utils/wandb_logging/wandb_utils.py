...
class WandbLogger():
    def __init__(self, opt, name, run_id, data_dict, job_type='Training'):
        ...
        if isinstance(opt.resume, str):  # checks resume from artifact
            ...
            self.wandb_run = wandb.init(config=opt,
                                        resume="allow",
                                        project='Oral Cancer' if opt.project == 'runs/train' else Path(opt.project).stem,
                                        name=name,
                                        job_type=job_type,
        ...
        if self.wandb_run:
            ...
            print(f"{prefix}Install Weights & Biases for Oral Cancer logging with 'pip install wandb' (recommended)")
    ...
    def check_and_upload_dataset(self, opt):
        ...
        config_path = self.log_dataset_artifact(opt.data,
                                                opt.single_cls,
                                                'Oral Cancer' if opt.project == 'runs/train' else Path(opt.project).stem)
